...
import (
	...
	"kubesphere.io/fluentbit-operator/api/fluentbit/v1alpha2/plugins/custom"
	"kubesphere.io/fluentbit-operator/api/fluentbit/v1alpha2/plugins/filter"
	"kubesphere.io/fluentbit-operator/api/fluentbit/v1alpha2/plugins/input"
	"kubesphere.io/fluentbit-operator/api/fluentbit/v1alpha2/plugins/output"
)
