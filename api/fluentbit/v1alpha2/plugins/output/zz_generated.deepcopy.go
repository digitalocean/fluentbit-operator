...
func (in *InfluxDB) DeepCopyInto(out *InfluxDB) {
	*out = *in
	...
	if in.HTTPToken != nil {
		in, out := &in.HTTPToken, &out.HTTPToken
		*out = new(plugins.Secret)
		(*in).DeepCopyInto(*out)
	}
	if in.TagKeys != nil {
	...
	if in.AutoTags != nil {
		in, out := &in.AutoTags, &out.AutoTags
		*out = new(bool)
		**out = **in
	}
	if in.TagsListEnabled != nil {
		in, out := &in.TagsListEnabled, &out.TagsListEnabled
		*out = new(bool)
		**out = **in
	}
	if in.TLS != nil {
...
func (in *S3) DeepCopyInto(out *S3) {
	*out = *in
	if in.StaticFilePath != nil {
		in, out := &in.StaticFilePath, &out.StaticFilePath
		*out = new(bool)
		**out = **in
	}
	...
	if in.SendContentMd5 != nil {
		in, out := &in.SendContentMd5, &out.SendContentMd5
		*out = new(bool)
		**out = **in
	}
	if in.AutoRetryRequests != nil {
	...
	if in.PreserveDataOrdering != nil {
		in, out := &in.PreserveDataOrdering, &out.PreserveDataOrdering
		*out = new(bool)
		**out = **in
	}
